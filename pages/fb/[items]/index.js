...
export async function getServerSideProps(context) {
  ...
  const findPost = await fetch(`https://dreamweb0fardin.herokuapp.com/allRoutes/fullPost/${con}`,{method:'GET'});
  const json = await findPost.json();

    const usersloggedIn = await fetch("https://dreamweb0fardin.herokuapp.com/authentication/loggedIn",{
      credentials: "include",
      headers:{
    ...
    const loggedIn = await fetch("https://dreamweb0fardin.herokuapp.com/auth/loggedIn",{
      credentials: "include",
      headers:{
